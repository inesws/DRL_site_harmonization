...
output_base_name = "fusion_z_site_sex_xcov_h1_gamma100_alpha1_2step"
...
class AE(tf.keras.Model):
    ...
    def compile(self, optimizer_ae, optimizer_clf, jit_compile=False): #optimizer_clf
    ...
    def train_step(self, data):
        x, y = data
        fc, env = x
        y_true, y_sex_true = y  # Unpack the tuple of labels
        ...
        with tf.GradientTape() as tape:
            ...
            total_loss = self.alpha * (fc_reconstruction_loss + env_reconstruction_loss) + self.gamma * (xcov_loss +  xcov_sex_loss)
        ...
        with tf.GradientTape() as tape: # foward propagation
            ...
            clf_loss = self.loss_sup(y_true, y_pred)
