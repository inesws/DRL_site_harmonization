...
save_results = "/home/isampaio/Desktop/Ines/DRL_site/results/combat_sex/"
...
for r in range(0,2):
    ...
    for i, (train_ind, val_ind) in enumerate(skf.split(stacked_FC_matrices,labels.iloc[:,0].values)):
        ...
        X_val_harm = preprocessing_pipeline.transform(X_val_dict) # We don't fit combat in val set to avoid dataleakage
